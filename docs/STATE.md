...
_Last updated: 2026-07-18 (session 2 — juice + expanded card pool complete)_
...
3. Remaining candidate pool: more spells/classes (needs model retrain), endless mode post-win, local leaderboard, title screen art, ko/en toggle
